...
({
    1: [function (a, b, c) {
            ...
            (this, function (a) {
                ...
                function n(a, b, c) {
                    ...
                    f = d / e;
                    return f >= M ? e *= 10 : f >= N ? e *= 5 : f >= O && (e *= 2),
                    b < a ? -e : e
                }
                function o(a) {
                ...
                function r(a, c, d) {
                    return a = L.call(a, f).sort(b),
                    Math.ceil((d - c) / (2 * (q(a, .75) - q(a, .25)) * Math.pow(a.length, -1 / 3)))
                }
                function s(a, b, c) {
    ...
    3: [function (a, b, c) {
            ...
            (this, function (a) {
                ...
                function d(a) {
                    ...
                    (b = H.exec(a)) ? (b = parseInt(b[1], 16), new i(b >> 8 & 15 | b >> 4 & 240, b >> 4 & 15 | 240 & b, (15 & b) << 4 | 15 & b, 1)) : (b = I.exec(a)) ? e(parseInt(b[1], 16)) : (b = J.exec(a)) ? new i(b[1], b[2], b[3], 1) : (b = K.exec(a)) ? new i(255 * b[1] / 100, 255 * b[2] / 100, 255 * b[3] / 100, 1) : (b = L.exec(a)) ? f(b[1], b[2], b[3], b[4]) : (b = M.exec(a)) ? f(255 * b[1] / 100, 255 * b[2] / 100, 255 * b[3] / 100, b[4]) : (b = N.exec(a)) ? j(b[1], b[2] / 100, b[3] / 100, 1) : (b = O.exec(a)) ? j(b[1], b[2] / 100, b[3] / 100, b[4]) : P.hasOwnProperty(a) ? e(P[a]) : "transparent" === a ? new i(NaN, NaN, NaN, 0) : null
                }
                function e(a) {
                    return new i(a >> 16 & 255, a >> 8 & 255, 255 & a, 1)
                }
                function f(a, b, c, d) {
                    return d <= 0 && (a = b = c = NaN),
                    new i(a, b, c, d)
                }
                function g(a) {
                    return a instanceof c || (a = d(a)),
                ...
                function j(a, b, c, d) {
                    return d <= 0 ? a = b = c = NaN : c <= 0 || c >= 1 ? a = b = NaN : b <= 0 && (a = NaN),
                    new m(a, b, c, d)
                }
                function k(a) {
                    if (a instanceof m)
                        return new m(a.h, a.s, a.l, a.opacity);
                    if (a instanceof c || (a = d(a)), !a)
                        return new m;
                    if (a instanceof m)
                        return a;
                    a = a.rgb();
                    ...
                    j = h - g,
                    k = (h + g) / 2;
                    return j ? (i = b === h ? (e - f) / j + 6 * (e < f) : e === h ? (f - b) / j + 2 : (b - e) / j + 4, j /= k < .5 ? h + g : 2 - h - g, i *= 60) : j = k > 0 && k < 1 ? 0 : i,
                ...
                function o(a) {
                    if (a instanceof q)
                        return new q(a.l, a.a, a.b, a.opacity);
                    if (a instanceof x) {
                        var b = a.h * Q;
                ...
                function v(a) {
                    if (a instanceof x)
                        return new x(a.h, a.c, a.l, a.opacity);
                ...
                function y(a) {
                    if (a instanceof A)
                        return new A(a.h, a.s, a.l, a.opacity);
                    a instanceof i || (a = g(a));
                    var b = a.r / 255,
                    c = a.g / 255,
                    d = a.b / 255,
                ...
                B(i, h, b(c, {
                        brighter: function (a) {
                            return a = null == a ? D : Math.pow(D, a),
                            new i(this.r * a, this.g * a, this.b * a, this.opacity)
                        },
                        darker: function (a) {
                            return a = null == a ? C : Math.pow(C, a),
                            new i(this.r * a, this.g * a, this.b * a, this.opacity)
                        },
                        rgb: function () {
                            return this
                        ...
                        toString: function () {
                            var a = this.opacity;
                            return a = isNaN(a) ? 1 : Math.max(0, Math.min(1, a)),
                ...
                B(q, p, b(c, {
                        ...
                        rgb: function () {
                            ...
                            b = T * s(b),
                            c = V * s(c),
                            new i(t(3.2404542 * b - 1.5371385 * a - .4985314 * c), t( - .969266 * b + 1.8760108 * a + .041556 * c), t(.0556434 * b - .2040259 * a + 1.0572252 * c), this.opacity)
                        }
                    })),
                B(x, w, b(c, {
                        brighter: function (a) {
            ...
            (this, function (a) {
                ...
                function d(a, b) {
                    return a.trim().split(/^|\s+/).map(function (a) {
                        var c = "",
                        d = a.indexOf(".");
                        if (d >= 0 && (c = a.slice(d + 1), a = a.slice(0, d)), a && !b.hasOwnProperty(a))
                ...
                c.prototype = b.prototype = {
                    ...
                    on: function (a, b) {
                        ...
                        j = h.length; {
                            ...
                            for (; ++i < j; )
                                if ((c = (a = h[i]).type) && (c = e(g[c], a.name)))
                                    return c
                        }
                    },
                    copy: function () {
            ...
            (this, function (a) {
                ...
                function k(a) {
                    function b(a) {
                        ...
                        u = q[o],
                        v = !o || /[defgprs%]/.test(o);
                        return n = null == n ? o ? 6 : 12 : /[gprs]/.test(o) ? Math.max(1, Math.min(21, n)) : Math.max(0, Math.min(20, n)),
                        b.toString = function () {
                            return a + ""
                        },
                        b
    ...
    6: [function (a, b, c) {
            ...
            (this, function (a, b) {
                ...
                L = function (a, b) {
                    ...
                    h.length < 2 ? i[0] ? k(i[0].x) : j(b) : (b = i.length, function (a) {
                        for (var c, d = 0; d < b; ++d)
                            h[(c = i[d]).i] = c.x(a);
                        return h.join("")
                    })
                ...
                Q = function (a, b, c, d, e, f) {
                    ...
                    h,
                    i;
                    return (g = Math.sqrt(a * a + b * b)) && (a /= g, b /= g),
    ...
    7: [function (a, b, c) {
            ...
            (this, function (a, b, c, d, e, f, g, h) {
                ...
                function k(a) {
                    var b = a.copy;
                    return a.padding = a.paddingOuter,
                ...
                function u(a, b) {
                    function c() {
                        return f = Math.min(i.length, j.length) > 2 ? s : r,
                        g = h = null,
                        e
                    }
                    function e(b) {
                ...
                function v(a, c, d) {
                    ...
                    case "s":
                        ...
                        return null != d.precision || isNaN(f = e.precisionPrefix(i, j)) || (d.precision = f),
                        e.formatPrefix(d, j);
                    case "":
                    case "e":
                    case "g":
                ...
                function w(a) {
                    ...
                    a.nice = function (d) {
                        ...
                        i = e[f],
                        j = b.tickStep(h, i, g);
                        return j && (j = b.tickStep(Math.floor(h / j) * j, Math.ceil(i / j) * j, g), e[0] = Math.floor(h / j) * j, e[f] = Math.ceil(i / j) * j, c(e)),
                        a
                    },
                    a
                }
                ...
                function G() {
                    ...
                    c.ticks = function (a) {
                        ...
                        if (!(f % 1) && o - n < p) {
                            ...
                            q = b.ticks(n, o, Math.min(o - n, p)).map(h);
                        return c ? q.reverse() : q
                    },
                    c.tickFormat = function (a, b) {
                        if (null == b && (b = 10 === f ? ".0e" : ","), "function" != typeof b && (b = e.format(b)), a === 1 / 0)
                            return b;
                        null == a && (a = 10);
    ...
    8: [function (a, b, c) {
            ...
            (this, function (a) {
                ...
                function b(a) {
                    var b = a += "",
                    c = b.indexOf(":");
                    return c >= 0 && "xmlns" !== (b = a.slice(0, c)) && (a = a.slice(c + 1)),
                    Qa.hasOwnProperty(b) ? {
                        space: Qa[b],
                        local: a
                    }
                        ...
                        if (i)
                            for (var k = 0, l = i.length; k < l; ++k)
                                if ((h = i[k]).type === a.type && h.name === a.name)
                                    return this.removeEventListener(h.type, h.listener, h.capture), this.addEventListener(h.type, h.listener = j, h.capture = c), void(h.value = b);
                ...
                function q(a) {
                    var b = o();
                    return b.changedTouches && (b = b.changedTouches[0]),
                    p(a, b)
                }
                function r() {}
                function s(a) {
                ...
                function E(a, b) {
                    if (!a)
                        return n = new Array(this.size()), j = -1, this.each(function (a) {
                            n[++j] = a
                        }), n;
                    var c = b ? D : C,
                    d = this._parents,
                ...
                function ga(a) {
                    this._node = a,
                    this._names = ea(a.getAttribute("class") || "")
                }
                function ha(a, b) {
                ...
                function Fa(a, b, c) {
                    var d = X(a),
                    e = d.CustomEvent;
                    e ? e = new e(b, c) : (e = d.document.createEvent("Event"), c ? (e.initEvent(b, c.bubbles, c.cancelable), e.detail = c.detail) : e.initEvent(b, !1, !1)),
                    a.dispatchEvent(e)
                }
                function Ga(a, b) {
                    return function () {
                ...
                function f(a) {
                    ...
                    function f(a, b) {
                        return function (c) {
                            ...
                            if ("p" in f && (f.H = f.H % 12 + 12 * f.p), "W" in f || "U" in f) {
                                ...
                                f.m = 0,
                                f.d = "W" in f ? (f.w + 6) % 7 + 7 * f.W - (i + 5) % 7 : f.w + 7 * f.U - (i + 6) % 7
                            }
                    ...
                    function g(a, b, c, d) {
                        for (var e, f, g = 0, h = b.length, i = c.length; g < h; ) {
                            ...
                            if (e = b.charCodeAt(g++),
                                37 === e) {
                                if (e = b.charAt(g++), f = La[e in da ? b.charAt(g++) : e], !f || (d = f(a, c, d)) < 0)
                                    return -1
    ...
    10: [function (a, b, c) {
            ...
            (this, function (a) {
                ...
                function b(a, c, d, g) {
                    function h(b) {
                        return a(b = new Date(+b)),
                        b
                    }
                    return h.floor = h,
                    h.ceil = function (b) {
                        return a(b = new Date(b - 1)),
                        c(b, 1),
                        a(b),
                        b
                    },
                    ...
                    h.offset = function (a, b) {
                        return c(a = new Date(+a), null == b ? 1 : Math.floor(b)),
                        a
                    },
                    h.range = function (b, d, e) {
                        var f = [];
                        if (b = h.ceil(b), e = null == e ? 1 : Math.floor(e), !(b < d && e > 0))
                            return f;
                        do
                            f.push(new Date(+b));
                        while (c(b, e), a(b), b < d);
                    ...
                    d && (h.count = function (b, c) {
                        ...
                        isFinite(a) && a > 0 ? a > 1 ? h.filter(g ? function (b) {
                            return g(b) % a === 0
                        }
                             : function (b) {
                ...
                g.every = function (a) {
                    return a = Math.floor(a),
                    isFinite(a) && a > 0 ? a > 1 ? b(function (b) {
                ...
                r = b(function (a) {
                    ...
                    b < 0 && (b += k),
                    a.setTime(Math.floor((+a - b) / k) * k + b)
                }, function (a, b) {
                    a.setTime(+a + b * k)
                }, function (a, b) {
                    return (b - a) / k
    ...
    11: [function (a, b, c) {
            ...
            function e() {
                function a(a) {
                    ...
                    i.enter().append("g").attr("class", p + "legendCells"),
                    ...
                    () : "horizontal" === y && (I = function (a, b) {
                        return "translate(" + b * (H[b].width + l) + ",0)"
                    }, J = function (a, b) {
                        return "translate(" + (H[b].width * K + H[b].x) + ",\n          " + (H[b].height + H[b].y + u + 8) + ")"
                    }),
                    g.default.d3_placement(y, j, I, F, J, v),
                    g.default.d3_title(a, r, p, B),
    ...
    13: [function (a, b, c) {
            ...
            k = function (a, b, c) {
                ...
                if (b.length > 1)
                    ...
                    for (var e = a.domain(), f = (e[e.length - 1] - e[0]) / (b - 1), g = 0; g < b; g++)
                        d.push(e[0] + g * f);
                var h = d.map(c);
                return {
                    data: d,
            ...
            c.default = {
                ...
                d3_addText: function (a, b, c, d, e) {
                    ...
                    return e && a.selectAll("g." + d + "cell text." + d + "label").call(i, e),
                    f
                },
                d3_calcType: function (a, b, c, d, e, f) {
                    var g = a.invertExtent ? l(a, e, f) : a.ticks ? k(a, c, e) : m(a),
                    i = a.range && a.range() || a.domain();
                    return g.labels = j(g.labels, d, a.domain(), i, f),
                    b && (g.labels = h(g.labels), g.data = h(g.data)),
                    g
                },
                ...
                d3_title: function (a, b, c, d) {
                    if ("" !== b) {
                        ...
                        e.data([b]).enter().append("text").attr("class", c + "legendTitle"),
                        a.selectAll("text." + c + "legendTitle").text(b),
                        d && a.selectAll("text." + c + "legendTitle").call(i, d);
    ...
    14: [function (a, b, c) {
            ...
            function e() {
                function a(a) {
                    ...
                    i.enter().append("g").attr("class", n + "legendCells");
                    ...
                    j.exit().transition().style("opacity", 0).remove(),
                    B.exit().transition().style("opacity", 0).remove(),
                    B = B.merge(B),
                    "line" === c ? (g.default.d3_drawShapes(c, B, 0, d), B.attr("stroke-width", h.feature)) : g.default.d3_drawShapes(c, B, h.feature, h.feature, h.feature, x);
                    ...
                    E = B.nodes().map(function (a, d) {
                        var e = a.getBBox(),
                        f = b(h.data[d]);
                        return "line" === c && "horizontal" === v ? e.height = e.height + f : "line" === c && "vertical" === v && (e.width = e.width),
                        e
                    }),
                    ...
                    (),
                    g.default.d3_placement(v, j, H, C, I, s),
                    g.default.d3_title(a, o, n, y),
                    j.transition().style("opacity", 1)
                }
                var b = (0, i.scaleLinear)(),
                c = "rect",
    ...
    15: [function (a, b, c) {
            ...
            function e() {
                function a(a) {
                    ...
                    g.default.d3_addEvents(B, A),
                    j.exit().transition().style("opacity", 0).remove(),
                    C.exit().transition().style("opacity", 0).remove(),
                    C = C.merge(C),
                    g.default.d3_drawShapes(c, C, e, d, f, h.feature);
                    ...
                    () : "horizontal" === x && (I = function (a, b) {
                        return "translate( " + b * (H + l) + ",0)"
                    }, J = function (a, b) {
                        return "translate( " + (F[b].width * K + F[b].x) + ",\n              " + (G + u) + ")"
                    }),
                    g.default.d3_placement(x, j, I, D, J, t),
                    g.default.d3_title(a, q, p, z),
                    j.transition().style("opacity", 1)
                }
                var b = (0, i.scaleLinear)(),
                c = "path",
